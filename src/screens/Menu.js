...
const FloatingParticles = () => {
  // Create 25 particles with random positions and animations
    ...
    <View style={styles.logoContainer}>
      ...
      >
        ...
        >
          ...
          <View style={[styles.logoAccent, { top: size * 0.15, left: size * 0.2 }]} />
          <View style={[styles.logoAccent, { bottom: size * 0.15, left: size * 0.25 }]} />
        </Animated.View>
      </Animated.View>
      ...
      >
        ...
        <View style={styles.taglineContainer}>
          ...
          <Text style={styles.taglineText}>MENU PRINCIPAL</Text>
          <View style={styles.taglineLine} />
        </View>
      </Animated.View>
    </View>
...
const MenuButton = ({ icon, label, onPress, delay = 0, style }) => {
  ...
  return (
    <Animated.View
      style={[
        ...
        {
          opacity: opacityAnim,
          transform: [{ scale: scaleAnim }, { translateY: translateYAnim }, { rotate }],
        },
      ]}
    >
      <TouchableOpacity
      ...
      >
        ...
        <View style={styles.menuButtonContent}>
          ...
          <View style={styles.menuButtonIcon}>
            <Text style={styles.menuButtonIconText}>{icon}</Text>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.menuButtonsContainer}>
          <MenuButton
            icon="📝"
            label="CADASTRAR SOLTURA"
            onPress={navigateToFormulario}
            delay={400}
            style={styles.menuButtonTop}
          />

          <MenuButton icon="📊" label="HISTÓRICO DE SOLTURAS" onPress={navigateToHistorico} delay={600} />
        </View>
